...
const displayCategories = (categories) => {
  ...
  categories.forEach((item) => {
    ...
    button.addEventListener("click", () => {
      if (selectedButton) {
        selectedButton.classList.remove("border-teal-600", "text-teal-600");
      }
        ...
        <section >
          ...
          <div class= "p-4 shadow-xl rounded-lg">
            ...
            <div class="flex justify-between mt-2 ">
              <button class="text-[#0E7A81] font-semibold   py-2 md:px-4 px-6  shadow-lg border-2 border-teal-200 rounded-lg" onclick="addToLikeContainer('${
                pet.image
              }')">
                <i class="fa-regular fa-thumbs-up"></i>
              </button>
              <button class="text-[#0E7A81] font-semibold  py-2 md:px-4 px-6  shadow-lg border-2 border-teal-200 rounded-lg" onclick="adoptPet(this)" >Adopt</button>
             <button class="text-[#0E7A81] font-semibold py-2 md:px-4 px-6 shadow-lg border-2 border-teal-200 rounded-lg" onclick="fetchPetDetails(${
               pet.petId
             })">Details</button>
